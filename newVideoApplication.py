...
class App():
    def __init__(self, video_source):
        ...
        self.settings_button = ct.CTkButton(self.window, width = 125, height = 125, text = "Settings", command = self.openSettings).pack(side = ct.TOP, padx = 5, pady = 2)
        self.screenshot_button = ct.CTkButton(self.window, width = 125, height = 125, text = "Screenshot", command = self.takeScreenshot).pack(side = ct.BOTTOM, padx = 5, pady = 2)
    ...
    def openSettings(self):
        ...
        self.backend_dropdown = ct.CTkOptionMenu(master = settingsWindow, values = ['opencv', 'ssd', 'dlib', 'mtcnn', 'retinaface', 'mediapipe'], variable = self.backend_choice) # Creates choices for the dropdown menu
        ...
        self.model_dropdown = ct.CTkOptionMenu(master = settingsWindow, values = ['VGG-Face', 'Facenet', 'Facenet512', 'OpenFace', 'DeepFace', 'DeepID', 'ArcFace', 'Dlib', 'SFace'], variable = self.model_choice) # Creates choices for the dropdown menu
